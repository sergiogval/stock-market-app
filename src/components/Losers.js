...
import { getLosers } from '../redux/losers/losers';
...
const Losers = () => {
  const globalState = useSelector((state) => state.loserReducer);
  ...
  return (
    <div className="popular-stock-container gainer-loser-container">
      <header className="loser-main-header">
        <GobakcBtn path="/" />
        <h1>Loser stocks</h1>
        <select name="sort" id="sortPopular" onChange={filterTheStocks} disabled>
